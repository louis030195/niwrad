...
goog.exportSymbol('proto.nakama.niwrad.api.rpc.UnityServer', null, global);
goog.exportSymbol('proto.nakama.niwrad.api.rpc.User', null, global);
/**
 ...
 * @constructor
 */
proto.nakama.niwrad.api.rpc.User = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.nakama.niwrad.api.rpc.User.repeatedFields_, null);
};
goog.inherits(proto.nakama.niwrad.api.rpc.User, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.nakama.niwrad.api.rpc.User.displayName = 'proto.nakama.niwrad.api.rpc.User';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.nakama.niwrad.api.rpc.UnityServer = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.nakama.niwrad.api.rpc.UnityServer, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.nakama.niwrad.api.rpc.UnityServer.displayName = 'proto.nakama.niwrad.api.rpc.UnityServer';
}
 ...
 * @const
 */
proto.nakama.niwrad.api.rpc.User.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.nakama.niwrad.api.rpc.User.prototype.toObject = function(opt_includeInstance) {
  return proto.nakama.niwrad.api.rpc.User.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nakama.niwrad.api.rpc.User} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nakama.niwrad.api.rpc.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    matchesOwnedList: jspb.Message.getRepeatedField(msg, 1)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.nakama.niwrad.api.rpc.User}
 */
proto.nakama.niwrad.api.rpc.User.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.nakama.niwrad.api.rpc.User;
  return proto.nakama.niwrad.api.rpc.User.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nakama.niwrad.api.rpc.User} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nakama.niwrad.api.rpc.User}
 */
proto.nakama.niwrad.api.rpc.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.nakama.niwrad.api.rpc.User.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.nakama.niwrad.api.rpc.User.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nakama.niwrad.api.rpc.User} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nakama.niwrad.api.rpc.User.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMatchesOwnedList();
  if (f.length > 0) {
 ...
 * @return {!Array<string>}
 */
proto.nakama.niwrad.api.rpc.User.prototype.getMatchesOwnedList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};


/** @param {!Array<string>} value */
proto.nakama.niwrad.api.rpc.User.prototype.setMatchesOwnedList = function(value) {
 ...
 */
proto.nakama.niwrad.api.rpc.User.prototype.addMatchesOwned = function(value, opt_index) {
 ...
 */
proto.nakama.niwrad.api.rpc.User.prototype.clearMatchesOwnedList = function() {
  this.setMatchesOwnedList([]);
};
 ...
 * @return {!Object}
 */
proto.nakama.niwrad.api.rpc.UnityServer.prototype.toObject = function(opt_includeInstance) {
  return proto.nakama.niwrad.api.rpc.UnityServer.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nakama.niwrad.api.rpc.UnityServer} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nakama.niwrad.api.rpc.UnityServer.toObject = function(includeInstance, msg) {
  var f, obj = {
    matchId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.nakama.niwrad.api.rpc.UnityServer}
 */
proto.nakama.niwrad.api.rpc.UnityServer.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.nakama.niwrad.api.rpc.UnityServer;
  return proto.nakama.niwrad.api.rpc.UnityServer.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nakama.niwrad.api.rpc.UnityServer} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nakama.niwrad.api.rpc.UnityServer}
 */
proto.nakama.niwrad.api.rpc.UnityServer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.nakama.niwrad.api.rpc.UnityServer.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.nakama.niwrad.api.rpc.UnityServer.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nakama.niwrad.api.rpc.UnityServer} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nakama.niwrad.api.rpc.UnityServer.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMatchId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.nakama.niwrad.api.rpc.UnityServer.prototype.getMatchId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.nakama.niwrad.api.rpc.UnityServer.prototype.setMatchId = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
