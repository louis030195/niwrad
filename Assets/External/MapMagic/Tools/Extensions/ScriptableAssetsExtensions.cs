	...
	public static class ScriptableAssetExtensions
	{
		...
		public static void ShowObjectSelector (Type objType, int id=12345, bool allowSceneObjects=false, Action<UnityEngine.Object> onClosed=null, Action<UnityEngine.Object> onUpdated=null)
		{
			...
			MethodInfo showMethod = objectSelectorType.GetMethod(
				...
				new Type[] { typeof(UnityEngine.Object), typeof(Type), typeof(UnityEditor.SerializedProperty), typeof(bool), typeof(List<int>), typeof(Action<UnityEngine.Object>), typeof(Action<UnityEngine.Object>) }, 
				null);
			showMethod.Invoke(objectSelector, new object[]{null, objType, null, allowSceneObjects, null, onClosed, onUpdated});  //(obj, objType, property, allowSceneObjects);
